package com.callbin.myssm.myspringmvc;


import com.callbin.myssm.ioc.BeanFactory;
import com.callbin.myssm.util.StringUtil;
            ...
            for (Method method : methods) {
                if (operate.equals(method.getName())) {
                    ...
                    if (methodReturnStr.startsWith("redirect:")) {        //比如：  redirect:fruit.do
                        ...
                        String jsonStr = methodReturnStr.substring("json:".length()); // 比如：  json:xxx
